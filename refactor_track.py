...
filepath = r'd:\Works\Vahan_Mitra\lib\ui\screens\track_all_buses_screen.dart'
...
class _TrackAllBusesScreenState extends ConsumerState<TrackAllBusesScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final southIndiaBounds = LatLngBounds(
      southwest: const LatLng(8.0, 74.0),
      northeast: const LatLng(16.0, 81.0),
    );
          ...
          data: (buses) {
            ...
            if (_focusedBusIndex != null && _focusedBusIndex! < buses.length) {
              ...
              for (int i = 0; i < buses.length; i++) {
                ...
                if (idx % 3 == 0) hue = BitmapDescriptor.hueAzure;
                else if (idx % 3 == 1) hue = BitmapDescriptor.hueGreen;
                else hue = BitmapDescriptor.hueOrange;
                idx++;
            ...
            return Stack(
              children: [
                GoogleMap(
                  ...
                  markers: markers,
                  cameraTargetBounds: CameraTargetBounds(southIndiaBounds),
